...
public enum Role {
    ...
    SHAPESHIFTER("shapeshifter", ChatColor.GREEN + "Shapeshifter", ChatColor.GREEN + "Ego-Shapeshifter", "emerald-block", CustomInventoryOverlay.ROLES_SHAPESHIFTER.getUnicodeCharacter(), Material.AIR, ChatColor.GREEN + "Shapeshifter", ChatColor.GRAY + "heeft gewonnen", PlayerData.UserDataType.EGOWINS);
